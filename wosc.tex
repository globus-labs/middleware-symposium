...
\title{Leveraging Serverless to Dynamically Extract Metadata from Files at the Edge}
...
automatically construct file extraction workflows subject to users' cost, time, security, and compute allocation constraints. 
...
\name{} is a serverless middleware that addresses data locality and scalability challenges by deploying compute endpoints on the edge
devices and constructing these workflows subject to a number of user constraints. Such a system will enable companies, researchers, and individuals alike to more easily find, understand, and share increasingly 
