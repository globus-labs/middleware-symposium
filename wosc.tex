...
HPC task queue. Additionally for some workloads, moving data can be prohibitively expensive. For instance, electron 
...
a sunk cost. Oftentimes metadata 


The primary goal of this work is the following: 

implement and evaluate a serverless metadata extraction system
that allows users to deploy endpoints at the edge on which metadata extraction functions can be run

creating a comprehensive, searchable index of files across multiple edge devices
